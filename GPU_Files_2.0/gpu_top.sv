...
// Bw fetch_decode unit and Inst_mem
 ...
 logic [NO_LANES-1:0] default_mask = {NO_LANES{32'b11111111111111111111111111111111}};
 
 /* other Masking ways
 logic [NO_LANES-1:0] default_mask = {NO_LANES{32'b00000000000000001111111111111111}};

 logic [NO_LANES-1:0] default_mask = {NO_LANES{32'b10101010101010101010101010101010}};

 logic [NO_LANES-1:0] default_mask = {NO_LANES{32'b00000000000000000000000000000001}};
